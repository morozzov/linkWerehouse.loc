    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="personalBoard.php" class="nav-link px-2 link-secondary">Your board</a></li>
            </ul>
...
<article class="card-body">
    <div class="container my-3">
        <a href="addLink.php" style='text-decoration: none; color: #191c1f;'>
    ...
    <?php
    $result = mysqli_query($mysqli, "SELECT * FROM `links` WHERE userId='$id'");
    ...
    if ($countRows != 0) {
        foreach ($result as $row) {
            ...
            echo "<form class='form-control border-0' method='post' action='deleteHandler.php'>
            ...
            echo "</div>";
            echo "<div class='p-2 bd-highlight'>";
            echo "<form class='form-control border-0' method='post' action='editLink.php'>
                                           <input type='text' value='{$row['id']}' hidden='hidden' name='rowId'>
